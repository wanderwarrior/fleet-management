...
exports.sendUserDecisionEmail = exports.sendApprovalRequestEmail = void 0;
...
exports.sendApprovalRequestEmail = functions.https.onCall(async (request) => {
    const { userEmail, userName, uid, token, appUrl } = request.data;
...
exports.sendUserDecisionEmail = functions.https.onCall(async (request) => {
    const { userEmail, userName, status } = request.data;
